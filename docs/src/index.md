...
installed. It is recommended to install and update via *juliaup*. Alternatively, pre-made installers are 
...
environment) and *then* add the package.
...
AttainableRegionTutorial.jl is published under the permissive open-source [MIT license](https://github.com/thomvet/AttainableRegionTutorial.jl/blob/main/LICENSE). See also the corresponding [Wikpedia article](https://en.wikipedia.org/wiki/MIT_License). 
